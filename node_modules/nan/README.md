...
`Nan::Callback` makes it easier to use `v8::Function` handles as callbacks. A class that wraps
...
If a change proposal cannot reach a consensus, a WG member can call for a vote amongst the members
